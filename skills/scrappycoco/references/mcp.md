...
For social research, hooks, account critiques, creators, trends and ad
inspiration, use the [social research cookbook](social-research.md) to compose
`input.question` and evaluate the answer. Its briefs apply to MCP unchanged.
